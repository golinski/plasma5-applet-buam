...
void Buam::bookTableDownloaded(QNetworkReply* reply) {
    ...
    while(ts.readLineInto(&s)) {
        ...
        while ((pos = bookTitle.indexIn(s, pos)) != -1) {
            ...
            book.title.replace(QString("&oacute;"), QString("ó"));
            book.title.replace(QString("&Oacute;"), QString("Ó"));
            book.title.replace(QString("&#260;"), QString("Ą"));
            book.title.replace(QString("&#261;"), QString("ą"));
            book.title.replace(QString("&#262;"), QString("Ć"));
            book.title.replace(QString("&#263;"), QString("ć"));
            book.title.replace(QString("&#280;"), QString("Ę"));
            book.title.replace(QString("&#281;"), QString("ę"));
            book.title.replace(QString("&#321;"), QString("Ł"));
            book.title.replace(QString("&#322;"), QString("ł"));
            book.title.replace(QString("&#323;"), QString("Ń"));
            book.title.replace(QString("&#324;"), QString("ń"));
            book.title.replace(QString("&#211;"), QString("Ó"));
            book.title.replace(QString("&#243;"), QString("ó"));
            book.title.replace(QString("&#346;"), QString("Ś"));
            book.title.replace(QString("&#347;"), QString("ś"));
            book.title.replace(QString("&#377;"), QString("Ź"));
            book.title.replace(QString("&#378;"), QString("ź"));
            book.title.replace(QString("&#379;"), QString("ż"));
            book.title.replace(QString("&#380;"), QString("ż"));
